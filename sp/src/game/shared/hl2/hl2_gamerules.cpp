...
ConVar  alyx_darkness_force( "alyx_darkness_force", "0", FCVAR_CHEAT | FCVAR_REPLICATED );
	...
	void CHalfLife2::InitDefaultAIRelationships( void )
	{
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_EARTH_FAUNA,			CLASS_HOUNDEYE,			D_NU, 0);
...
CAmmoDef *GetAmmoDef()
{
	...
	if ( !bInitted )
	{
		...
		def.AddAmmoType("9mmRounds",		DMG_BULLET,					TRACER_LINE_AND_WHIZ,	"sk_plr_dmg_9mm",			"sk_npc_dmg_9mm",			"sk_max_9mm",			BULLET_IMPULSE(200, 1225), 0 );
