...
public:
	...
	//int SpitOutClawConditions( void );
	...
	//void SquidHungerLevel(void);
	//bool m_bCanCheckHunger;
...
private:
	...
	int	  m_RandomHCGib;
	//float m_flNextHuntTime; // Time until I want to eat headcrabs again, whether that be knocking them off zombies, or eating them from the ground.
	//int	  m_HungerLevel;	// How much the bullsquid currently has in its stomach.
	int   m_CrabTypeEaten;
	...
	bool SeenSquidEnemyWithinTime(float flTime);
